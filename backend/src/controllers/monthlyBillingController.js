...
const getCycleMonthString = (start, end) => {
...
const parseCycleDates = (monthStr) => {
...
// ==========================================
export const generateBulkMonthlyBills = async (req, res) => {
    try {
...
// ==========================================
export const getRenterMonthlyBills = async (req, res) => {
    try {
        const userId = Number(req.userId);
...
// ==========================================
export const getAllMonthlyBills = async (req, res) => {
    try {
...
// ==========================================
export const updateMonthlyBill = async (req, res) => {
    try {
        const { billId } = req.params;
...
// ==========================================
export const deleteMonthlyBill = async (req, res) => {
    try {
        const { billId } = req.params;
        const bill = await prisma.monthlyBill.findUnique({
            where: { id: parseInt(String(billId)) },
...
export const verifyMonthlyPayment = async (req, res) => {
    try {
        ...
        let newStatus = MonthlyBillStatus.PARTIAL;
...
export const getRoomBillingHistory = async (req, res) => {
    try {
...
// ==========================================
export const sendMonthlyInvoice = async (req, res) => {
    try {
        const { billId } = req.params;
...
// ==========================================
export const requestStayRenewal = async (req, res) => {
    try {
        const userId = Number(req.userId);
...
// ==========================================
export const triggerMonthlyReminders = async (req, res) => {
    try {
...
// ==========================================
export const sendRenterReminder = async (req, res) => {
    try {
...
// ==========================================
export const requestRenterCheckout = async (req, res) => {
    try {
        const userId = Number(req.userId);
        if (!userId) {
...
// ==========================================
export const rejectRenterCheckout = async (req, res) => {
    try {
        const { bookingId } = req.params;
        const numericBookingId = Number(bookingId);
        if (isNaN(numericBookingId)) {
 ...
 */
export const requestContinueStay = async (req, res) => {
    try {
        const userId = Number(req.userId);
        const booking = await prisma.booking.findFirst({
            where: {
 ...
 */
export const getPendingRenewalRequests = async (req, res) => {
    try {
 ...
 */
export const approveContinueStay = async (req, res) => {
    try {
 ...
 */
export const rejectContinueStay = async (req, res) => {
    try {
        const { requestId } = req.params;
...
//# sourceMappingURL=monthlyBillingController.js.map