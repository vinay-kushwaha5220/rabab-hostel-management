...
// ==========================================
export const createBookingRazorpayOrder = async (req: AuthRequest, res: Response) => {
  try {
...
// ==========================================
export const verifyBookingRazorpayPayment = async (req: AuthRequest, res: Response) => {
  try {
    const { 
