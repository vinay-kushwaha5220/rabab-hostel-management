  ...
  try {
    ...
    const room = await prisma.room.create({
      data: {
        ...
        description,
        price: Number(price),
        dailyPrice: dailyPrice ? Number(dailyPrice) : Number(price) / 30,
  ...
  try {
    ...
    const updatedRoom = await prisma.room.update({
      ...
      data: {
        ...
        dailyPrice: dailyPrice ? Number(dailyPrice) : room.dailyPrice,
        monthlyPrice: monthlyPrice ? Number(monthlyPrice) : room.monthlyPrice,
