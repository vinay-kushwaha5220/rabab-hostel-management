...
async function main() {
  ...
  // Create Admin User
  const hashedPassword = await bcrypt.hash('Vinay@5220', 10)
  const adminEmail = 'radhey8542@gmail.com'
  ...
  console.log('✅ Admin user created: radhey8542@gmail.com / Vinay@5220')
