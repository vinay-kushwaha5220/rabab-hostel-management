          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all duration-200 snap-center whitespace-nowrap ${isActive
                  ...
                  <div className="space-y-3">
                    ...
                    {daysLeft !== null ? (
                      <div className="flex items-center gap-4 py-1">
                        <div className={`w-14 h-14 rounded-full flex flex-col items-center justify-center border-4 flex-shrink-0 ${daysLeft > 10
                      ...
                      return (
                        <Fragment key={msg.id}>
                          ...
                          <div className={`flex w-full ${isWarden ? 'justify-start' : 'justify-end'} mb-1`}>
                            ...
                            <div className={`max-w-[72%] px-3 py-1.5 pb-5 rounded-xl shadow-sm text-xs font-medium leading-relaxed relative ${isWarden
