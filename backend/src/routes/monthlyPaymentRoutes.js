...
import { processMonthlyPayment, getPaymentHistory, getAllPayments, getPaymentStats, createRazorpayOrder, verifyRazorpayPayment, } from "../controllers/monthlyPaymentController.js";
const router = Router();
// Renter routes
